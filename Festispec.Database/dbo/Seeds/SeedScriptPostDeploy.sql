...
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (1, N'Op een schaal van 1 tot 10 wat was de sfeer bij de eetgelegenheden', N'*1 – Er is niemand, 5 - Het is redelijk druk, 10 – Er is geen doorkomen aan', N'Beoordeling')
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (2, N'Geef een indruk van de sfeer impressie bij de eetgelegenheden', null, N'Beoordeling')
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (3, N'Maak een foto van opvallende situaties', N'Benoem hier de geüploade foto’s:', N'Foto''s')
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (4, N'Meet de afstand tussen de verschillende food trucks', null, N'Tekst')
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (5, N'Teken de algemene stroom van mensen op de kaart (bijlage A).', N'Eventuele opmerkingen:', N'Tekst')
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (6, N'Tel het aantal tafels en zitplaatsen bij de foodtrucks', null, N'Tekst')
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (7, N'Wat beschrijft het beste de sfeer bij het publiek na de shows bij de main stage?', N'-A: De sfeer is grimmig -B: Het publiek is rustig -C: Het publiek is dronken/aangeschoten -D: Het is chaos', N'Sfeer')
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (8, N'Geef het aantal mensen in de rij 5 minuten voor het begin van de elke theater show', null, N'Aantal mensen in rij')
INSERT INTO [dbo].[Question] ([Id], [Name], [Description], [QuestionType_Type]) VALUES (9, N'Hoe druk was het bij de WC''s? Maak elk uur een schatting', N'*(Gebruik je inschattingstechniek geleerd op de training dag)', N'Drukte')
...
INSERT INTO [dbo].[Regulation] ([Id], [Name], [Description], [Municipality]) VALUES (1, N'Alcohol Wet', N'Gij Mag Geen Alcohol Verkopen Aan Mensen Onder De 18 Jaar', N'Nederland')
INSERT INTO [dbo].[Regulation] ([Id], [Name], [Description], [Municipality]) VALUES (2, N'Drugs Wet', N'Gij Mag Geen Drugs Verkopen Aan Iedereen', N'Nederland')
