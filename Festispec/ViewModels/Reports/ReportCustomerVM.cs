...
{
    public class ReportCustomerVM : AddressViewModelBase<ICustomerRepositoryFactory, ICustomerRepository, Domain.Customer>
    {
        public ReportCustomerVM(ICustomerRepositoryFactory repositoryFactory) : base(repositoryFactory)
        {

        }

        public ReportCustomerVM(ICustomerRepositoryFactory repositoryFactory, Domain.Customer entity)
