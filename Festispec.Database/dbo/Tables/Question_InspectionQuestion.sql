CREATE TABLE [dbo].[Question_InspectionQuestion] (
    ...
    CONSTRAINT [FK_PlanningInspectionQuestion] FOREIGN KEY ([Planning_Inspection_Id], [Planning_Inspector_Id], [Planning_Date]) REFERENCES [dbo].[Planning] ([Inspection_Id], [Inspector_Id], [Date]) ON DELETE CASCADE
);
